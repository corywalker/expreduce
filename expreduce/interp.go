...
const (
	...
	DOTSYM          = 57397
	EQUALSYM        = 57374
	EXCLAMATIONSYM  = 57383
	EXPSYM          = 57364
	FLOAT           = 57346
	FUNCAPPSYM      = 57368
	FUNCTIONSYM     = 57384
	GETSYM          = 57393
	GREATEREQUALSYM = 57388
	GREATERSYM      = 57389
	INTEGER         = 57347
	LBRACKETSYM     = 57353
	LCURLYSYM       = 57355
...
var (
	CalcXLAT = map[int]int{
		...
		57379: 1,  // NAME (106x)
		57383: 2,  // EXCLAMATIONSYM (105x)
		57346: 3,  // FLOAT (105x)
		57393: 4,  // GETSYM (105x)
		57355: 5,  // LCURLYSYM (105x)
		57349: 6,  // LPARSYM (105x)
		57361: 7,  // MINUSSYM (105x)
		57380: 8,  // PATTERN (105x)
		57378: 9,  // SLOTSYM (105x)
		...
		57372: 17, // ALTSYM (61x)
		57391: 18, // ANDSYM (61x)
		57369: 19, // APPLYSYM (61x)
		57359: 20, // CONDITIONSYM (61x)
		57363: 21, // DIVSYM (61x)
		57397: 22, // DOTSYM (61x)
		57374: 23, // EQUALSYM (61x)
		57345: 24, // error (61x)
		57364: 25, // EXPSYM (61x)
		57368: 26, // FUNCAPPSYM (61x)
		57384: 27, // FUNCTIONSYM (61x)
		57388: 28, // GREATEREQUALSYM (61x)
		57389: 29, // GREATERSYM (61x)
		57386: 30, // LESSEQUALSYM (61x)
		57387: 31, // LESSSYM (61x)
		57370: 32, // MAPSYM (61x)
		57381: 33, // MESSAGENAMESYM (61x)
		57362: 34, // MULTSYM (61x)
		57390: 35, // ORSYM (61x)
		57371: 36, // PATTESTSYM (61x)
		57360: 37, // PLUSSYM (61x)
		57367: 38, // POSTFIXSYM (61x)
		57396: 39, // REPEATEDNULLSYM (61x)
		57395: 40, // REPEATEDSYM (61x)
		57358: 41, // REPLACEALLSYM (61x)
		57357: 42, // REPLACEREPSYM (61x)
		57366: 43, // RULEDELAYEDSYM (61x)
		57365: 44, // RULESYM (61x)
		57373: 45, // SAMESYM (61x)
		57352: 46, // SEMISYM (61x)
		57377: 47, // SETDELAYEDSYM (61x)
		57376: 48, // SETSYM (61x)
		57385: 49, // SPANSYM (61x)
		57382: 50, // STRINGJOINSYM (61x)
		57375: 51, // UNEQUALSYM (61x)
		57394: 52, // UNSAMESYM (61x)
		57350: 53, // RPARSYM (58x)
		57401: 54, // exprseq (3x)
		57392: 55, // COLONSYM (2x)
		57402: 56, // list (1x)
		57399: 57, // $default (0x)
		57398: 58, // MAPSYN (0x)
	}
	...
	CalcParseTab = [110][]uint16{
		...
		// 15
		{79, 73, 12, 78, 12, 71, 69, 12, 72, 75, 77, 81, 12, 12, 85, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 98, 118, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12},
		...
		{79, 73, 11, 78, 11, 71, 69, 11, 11, 11, 77, 81, 11, 11, 85, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 98, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11},
		...
		{79, 73, 83, 78, 76, 71, 69, 87, 72, 75, 77, 81, 38, 38, 85, 38, 38, 94, 116, 97, 103, 89, 115, 108, 38, 90, 92, 84, 113, 112, 111, 110, 98, 118, 88, 117, 93, 86, 91, 96, 95, 102, 101, 100, 99, 106, 82, 105, 104, 114, 119, 109, 107, 38},
		...
		{79, 73, 43, 78, 76, 71, 69, 43, 72, 75, 77, 81, 43, 43, 85, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 98, 118, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43, 43},
		// 80
		{79, 73, 44, 78, 76, 71, 69, 44, 72, 75, 77, 81, 44, 44, 85, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 92, 44, 44, 44, 44, 44, 98, 118, 44, 44, 93, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44},
		...
		// 85
		{79, 73, 83, 78, 76, 71, 69, 50, 72, 75, 77, 81, 50, 50, 85, 15, 50, 50, 50, 97, 50, 89, 115, 50, 50, 90, 92, 50, 50, 50, 50, 50, 98, 118, 88, 50, 93, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 119, 50, 50, 50},
		...
		{79, 73, 58, 78, 76, 71, 69, 58, 72, 75, 77, 81, 58, 58, 85, 58, 58, 58, 58, 97, 58, 58, 58, 58, 58, 58, 92, 58, 58, 58, 58, 58, 98, 118, 58, 58, 93, 58, 58, 58, 58, 58, 58, 58, 58, 58, 58, 58, 58, 58, 58, 58, 58, 58},
		...
		{79, 73, 56, 78, 76, 71, 69, 56, 72, 75, 77, 81, 56, 56, 85, 56, 56, 56, 56, 97, 56, 56, 56, 56, 56, 56, 92, 56, 56, 56, 56, 56, 98, 118, 56, 56, 93, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56},
