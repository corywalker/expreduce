...
func TestPlus(t *testing.T) {
	...
	assert.Equal(t, "(1. * (a + b))", EasyRun("(a + b)/1.", es))
	assert.Equal(t, "(2 * (a + b))", EasyRun("2*(a + b)", es))
	assert.Equal(t, "(a * (b + c))", EasyRun("a*(b + c)", es))
	assert.Equal(t, "((-1 * a) + (-1 * b))", EasyRun("-1*(a + b)", es))
	assert.Equal(t, "((-1 * a) + (-1 * b))", EasyRun("-(a + b)", es))
	assert.Equal(t, "(-1. * (a + b))", EasyRun("-1.*(a + b)", es))
	assert.Equal(t, "((-1 * a) + (-1 * b))", EasyRun("(a + b)/-1", es))
	assert.Equal(t, "(-1. * (a + b))", EasyRun("(a + b)/-1.", es))
